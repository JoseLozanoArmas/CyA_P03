...
class Alfabeto {
 public:
  ...
  void SetDivision(std::vector<std::string>& alfabeto_, std::string lineas); //Crea la división del alfabeto
 ...
 private:
  ...
  std::vector<std::string> division_; //Fraccionar la cadena en simbolos
};